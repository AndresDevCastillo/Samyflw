  ...
  <div class="inicio">
    <div class="bg">
      <div class="bubbles bubblesP">
        ...
        <span style="--i:17;"></span>
        <span style="--i:13;"></span>
        <span style="--i:28;"></span>{ <span style="--i:22;"></span>
        <span style="--i:24;"></span>
        <span style="--i:18;"></span>
        <span style="--i:14;"></span>
        <span style="--i:23;"></span>
    ...
    <div class="fondo">
      <section id="hero">
        <div class="hero-container">
          <h1 class="mb-4 pb-0  animation-duration-1000">Samyflw<br />Agencia
            <span>TikTok </span>
          </h1>
          ...
          <a href="https://api.whatsapp.com/send?phone=573176205370" target="_blank"
            class="about-btn animation-duration-1000">Whatsapp</a>
        </div>
      </section>
      <div class="bg">
        <div class="bubbles bubblesP">
        ...
        <div>
          <Panel :unstyled="true">
            ...
            <div style="display: flex; align-items: center; justify-content: center; width: 100%; gap: 1rem">
              <h2>Creadores Destacados </h2> <a href="https://www.tiktok.com/@samyflw"><svg
                  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="50"
