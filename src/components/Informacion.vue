            ...
            <div class="container">
                <div class="panel__wrapper-icon mb-100 brk-library-rendered" data-brk-library="component__panel">
                    <div class="panel__head all-light">
                        <h4 class="font__family-montserrat font__weight-medium font__size-21">Beneficios</h4>
                        <p class="font__family-open-sans font__size-21">Hola somos SAMYFLW. Agencia oficial de TikTok Live!
                            Queremos invitarte a que te unas a nosotros y accedas a diferentes beneficios como : </p>
                    </div>
                    <ul class="panel__list">
                        <li>
                            <span class="line"></span>
                            No cobramos porcentajes ni comisiones
                            por nuestro trabajo,
                            Capacitaciones y acompañamiento constantes.
                        </li>
                        <li>
                            <span class="line"></span>
                            <i class="icon fab fa-gg"></i>Participaciones en eventos anticipados y exclusivos para EMISORES
                            OFICIALES.
                        </li>
                        <li>
                            <span class="line"></span>
                            <i class="icon far fa-gem"></i>Phasellus nec sem in justo pellentesque facilisis. Etiam
                            imperdiet imperdiet orci. Nunc nec neque. Phasellus leo
                            dolor, tempus sollicitudin urrna
                        </li>
                        <li>
                            <span class="line"></span>
                            <i class="icon fab fa-gg"></i>Pellentesque posuere. Praesent turpis. Aenean posuere, tortor sed
                ...
                <div class="row">
                        ...
                        <div class="text-center text-lg-left">
                            <ul class="list-inline-4 mb-35 brk-library-rendered" data-brk-library="component__list">
                                <li class="font__family-montserrat font__size-16">
                                    <span class="before"></span><a href="#">Boxed &amp; Wide Layouts <i
                                            class="icon fa fa-angle-right"></i></a><span class="after"></span>
                                </li>
                                <li class="font__family-montserrat font__size-16">
                                    <span class="before"></span>Tons Color Schemes <i
                                        class="icon fa fa-angle-right"></i><span class="after"></span>
                                </li>
                                <li class="font__family-montserrat font__size-16">
                                    <span class="before"></span>Powerful Performance <i
                                        class="icon fa fa-angle-right"></i><span class="after"></span>
                                </li>
                            </ul>
                            <p
                                class="brk-dark-font-color font__size-16 font__weight-normal line__height-26 mb-25 pr-20 pr-xs-0">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="text-center text-lg-left">
                            <div class="text-center text-lg-left">
                                <h5 class="font__family-montserrat font__weight-light text-uppercase font__size-18 text-blue brk-library-rendered"
                                    data-brk-library="component__title">We are Awesome</h5>
                                <h2 class="font__family-roboto font__weight-thin line__height-52 font__size-46 text-uppercase letter-spacing-60 mt-20 brk-library-rendered"
                                    data-brk-library="component__title">Our Best Features</h2>
                                <h2 class="font__family-roboto font__weight-normal line__height-52 font__size-46 text-uppercase letter-spacing-60 brk-library-rendered"
                                    data-brk-library="component__title">&amp; Skills</h2>
                                <hr class="divider wow zoomIn ml-md-0 brk-library-rendered"
...
.panel__wrapper-icon .panel__head {
    background: linear-gradient(to right, #84DC16, #71be12);
    padding: 24px 40px;
